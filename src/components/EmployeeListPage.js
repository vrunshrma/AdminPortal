...
const EmployeeListPage = () => {
  ...
  useEffect(() => {
    getAllEmployee()
      .then((employeeResponse) => {
        ...
        console.log('User details:', employeeResponse.data.response);
  ...
  useEffect(() => {
    console.log('Updated userDetails:', userDetails);  // This will log whenever userDetails changes
  }, [userDetails]);
                    ...
                    {currentUsers && currentUsers.map((user, index) => (
                      <tr key={index}>
                        <td>
                          ...
                          <br />
                          <span className="user-subhead">{user.department}</span>
                        </td>
                        <td>
                        ...
                        <td style={{ width: '20%' }}>
                          ...
                          <a href="#" className="table-link" onClick={() => handleEditClick(user)}>
                            <span className="fa-stack">
                              <i className="fa fa-square fa-stack-2x"></i>
